      ...
      <section className="py-12 md:py-24 px-4 md:px-12 bg-surface min-h-[80vh]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 md:mb-16 text-center md:text-left">
            <h1 className="font-headline text-4xl sm:text-6xl md:text-8xl font-black uppercase italic tracking-tighter">OUR <span className="text-[#FF0033]">TRAINING</span></h1>
            <p className="font-body text-on-surface-variant text-base md:text-xl mt-6 max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0">
            ...
            <div className="group bg-surface-container-low p-5 md:p-10 border-b md:border-b-0 md:border-r border-neutral-800 last:border-0 hover:bg-surface-container-high transition-colors">
              ...
              <h3 className="font-headline text-xl md:text-3xl font-black uppercase italic tracking-tighter text-white mb-4">STRENGTH & CONDITIONING</h3>
              <p className="font-body text-on-surface-variant text-xs sm:text-sm md:text-base leading-relaxed mb-6">
            ...
            <div className="group bg-surface-container-low p-5 md:p-10 border-b md:border-b-0 md:border-r border-neutral-800 last:border-0 hover:bg-surface-container-high transition-colors">
              ...
              <h3 className="font-headline text-xl md:text-3xl font-black uppercase italic tracking-tighter text-white mb-4">COMBAT SPORTS</h3>
              <p className="font-body text-on-surface-variant text-xs sm:text-sm md:text-base leading-relaxed mb-6">
            ...
            <div className="group bg-surface-container-low p-5 md:p-10 border-b md:border-b-0 md:border-r border-neutral-800 last:border-0 hover:bg-surface-container-high transition-colors">
              ...
              <h3 className="font-headline text-xl md:text-3xl font-black uppercase italic tracking-tighter text-white mb-4">HIGH INTENSITY</h3>
              <p className="font-body text-on-surface-variant text-xs sm:text-sm md:text-base leading-relaxed mb-6">
