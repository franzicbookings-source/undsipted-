...
export default function Contact() {
  ...
  return (
    <Layout>
      <section className="py-16 md:py-24 px-6 md:px-12 bg-surface relative overflow-hidden min-h-[80vh]">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            <div>
              <h1 className="font-headline text-5xl sm:text-6xl md:text-8xl font-black uppercase italic tracking-tighter leading-none mb-10 md:mb-12">GET IN <span className="text-[#FF0033]">TOUCH</span></h1>
      ...
      {/* FAQ Section */}
      <section className="py-16 md:py-24 px-6 md:px-12 bg-surface-container-lowest border-t border-neutral-800 relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="space-y-4 md:space-y-6">
            {/* FAQ Item 1 */}
            <div className="bg-surface-container-low p-6 md:p-8 border-l-4 border-[#FF0033]">
              <h3 className="font-headline text-xl md:text-2xl font-black uppercase italic text-white mb-3">
            ...
            {/* FAQ Item 2 */}
            <div className="bg-surface-container-low p-6 md:p-8 border-l-4 border-[#FFFF00]">
              <h3 className="font-headline text-xl md:text-2xl font-black uppercase italic text-white mb-3">
            ...
            <div className="bg-surface-container-low p-6 md:p-8 border-l-4 border-[#FFFF00]">
              ...
              <div className="font-body text-on-surface-variant text-sm md:text-base leading-relaxed space-y-2">
