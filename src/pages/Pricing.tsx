...
export default function Pricing() {
  return (
    <Layout>
      <section className="py-12 md:py-24 px-4 md:px-12 bg-neutral-950 min-h-[80vh]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8 md:mb-16 text-center">
            <h1 className="font-headline text-4xl sm:text-6xl md:text-8xl font-black uppercase italic tracking-tighter">JOIN THE <span className="text-[#FF0033]">RANKS</span></h1>
